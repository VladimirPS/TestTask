...
Для api тестов нужно наследоваться от класса [UserApiClient.java] и создавать Actions класс относительно сервиса, общие конфиги брать из .properties файла, и общий настройки клиента добавлять в класс ApiClient.
